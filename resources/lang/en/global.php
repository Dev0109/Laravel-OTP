...
return [
    ...
    'project' => [
        'title' => 'Project',
        'project_list' => 'Offer list',
        'find_project' => 'Find a project',
        'find_project_ph' => 'Project name, reference, description...',
        'statuts_filter' => 'Statuts filter',
        'buttons' => [
            'new' => 'New',
            'modify' => 'Modify',
            'duplicate' => 'Duplicate',
        ...
        'search_customer' => 'Search a customer',
        ...
        'choice_off_app_and_models' => 'CHOICE OF APPLICATION AND MODELS',
        'display_compatible_models' => 'Display compatible models',
        'applications' => 'Applications',
        'airflow_data' => 'Airflow data',
        'application_type' => 'Application type',
        'installation_type' => 'Installation type',
        'recovery_technology' => 'Recovery technology',
        'climatic_data' => 'Climatic data',
        'winter' => 'WINTER',
        'summer' => 'SUMMER',
        'compliant_ranges' => 'Compliant ranges',
        'ranges_not_compatible_' => 'Ranges not compatible with selected input data',
        'results_table' => 'RESULTS TABLE',
        'pressure_curve' => 'PRESSURE CURVE',
        'power_consumption_curve' => 'POWER CONSUMPTION CURVE',
        'psfp_curve' => 'PSFP CURVE',

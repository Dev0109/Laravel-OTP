...
<div class="main-card">
    <div class="header">
        {{ trans('global.create') }} Competitor
    </div>

    <form method="POST" action="{{ route('admin.pricecompetitor.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="body">
            ...
            <div class="mb-3">
                ...
                @endif
                <span class="block">{{ trans('cruds.pricecompetitor.fields.name_helper') }}</span>
            </div>
            <div class="mb-3">
                <label for="pricelink" class="text-xs">{{ trans('cruds.pricecompetitor.fields.pricing_class') }}</label>

                <div class="form-group">
                    <input type="text" id="pricelink" name="pricelink" class="{{ $errors->has('pricelink') ? ' is-invalid' : '' }}" value="{{ old('pricelink') }}">
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="website" name="website" class="{{ $errors->has('website') ? ' is-invalid' : '' }}" value="{{ old('website') }}">
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="userpwd" name="userpwd" class="{{ $errors->has('userpwd') ? ' is-invalid' : '' }}" value="{{ old('userpwd') }}">
                </div>
            ...
            <div class="mb-3">
                <label for="pricelist" class="text-xs">{{ trans('cruds.pricecompetitor.fields.pricelist') }}</label>
            ...
            <div class="mb-3">
                <label for="datasheet" class="text-xs">{{ trans('cruds.pricecompetitor.fields.datasheet') }}</label>

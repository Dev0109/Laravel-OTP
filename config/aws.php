...
return [
    ...
    */
    'credentials' => [
        'key'    => env('AWS_ACCESS_KEY_ID', 'AKIAYHZRBISG7OTSZIGT'),
        'secret' => env('AWS_SECRET_ACCESS_KEY', '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'),
    ],
    'region' => env('AWS_REGION', 'en-south-1'),
    'version' => 'latest',
    'ua_append' => [
